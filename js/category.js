...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ОПРЕДЕЛЯЕМ, С КАКОГО СЕРВЕРА ПРИШЛИ
    ...
    document.title = `${categoryNames[categoryId] || 'Категория'} | AnarchyMarket`;
    ...
    // Функция отображения предложений (ТОЛЬКО КНОПКА "КУПИТЬ" ВЕДЁТ В ЧАТ)
    function renderOffers(offers) {
        ...
        // Кнопка "Купить" - открывает чат с продавцом
    ...
    // СОЗДАНИЕ ПРЕДЛОЖЕНИЯ (с привязкой к user_id)
